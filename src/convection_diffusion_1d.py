...
from fem_portfolio.src.mixins_1d.basis_functions import BasisFunctionMixin
from fem_portfolio.src.mixins_1d.mesh_refinement import AdaptiveRefinementMixin
from fem_portfolio.src.assembly.linear_system_assembly_1d import stiffness_matrix_1d, load_vector_1d
